// ISO 3166-1 alpha-2 country codes with names and coordinates (centroid)
export const countries: Record<string, { name: string; coords: [number, number] }> = {
  ...
  'CZ': { name: 'Czech Republic', coords: [49.8175, 15.4730] },
