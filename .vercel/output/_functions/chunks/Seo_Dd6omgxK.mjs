import { b as createAstro, c as createComponent, r as renderComponent, C as Fragment, a as renderTemplate, x as unescapeHTML } from './astro/server_DMB4Uz73.mjs';
import 'piccolore';
...
}, "/Users/florentbertiaux/Documents/GitHub/xteinkhub2026/node_modules/@astrolib/seo/src/AstroSeo.astro", void 0);
...
const $$Seo = createComponent(($$result, $$props, $$slots) => {
  ...
  const currentUrl = canonical || new URL(Astro2.url.pathname, siteUrl).toString();
  const defaultOgImage = ogImage || `${siteUrl}/api/og-image.png?title=${encodeURIComponent(title)}`;
  const localeMap = {
    en: "en_US",
    fr: "fr_FR",
    es: "es_ES",
  ...
  return renderTemplate`${renderComponent($$result, "AstroSeo", $$AstroSeo, { "title": title, "description": description, "canonical": currentUrl, "openGraph": {
    url: currentUrl,
    title,
    description,
    images: [
  ...
  } })} ${noindex && renderTemplate`<meta name="robots" content="noindex, nofollow">`} ${!noindex && renderTemplate`${renderComponent($$result, "Fragment", Fragment, {}, { "default": ($$result2) => renderTemplate` <meta name="robots" content="index, follow"> <meta name="googlebot" content="index, follow"> ` })}`}`;
}, "/Users/florentbertiaux/Documents/GitHub/xteinkhub2026/src/components/fundations/head/Seo.astro", void 0);
