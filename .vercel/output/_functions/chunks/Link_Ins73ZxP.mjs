...
const $$Link = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")}${addAttribute([
    ...variant === "link" ? [...linkClass, ...additionalClasses] : [
      "flex",
      "rounded-full",
      "items-center",
      "duration-300",
...
}, "/Users/florentbertiaux/Documents/GitHub/xteinkhub2026/src/components/fundations/components/Link.astro", void 0);
