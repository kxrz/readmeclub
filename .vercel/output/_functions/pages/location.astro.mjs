...
import 'piccolore';
import { g as getLangFromUrl, $ as $$BaseLayout, u as useTranslations, a as $$Wrapper, b as $$Text } from '../chunks/BaseLayout_CO6ejgXa.mjs';
...
const $$Location = createComponent(async ($$result, $$props, $$slots) => {
  ...
  })} </tbody> </table> </div> </div>`} </div> ` })} </section> ` }), renderScript($$result, "/Users/florentbertiaux/Documents/GitHub/xteinkhub2026/src/pages/location.astro?astro&type=script&index=0&lang.ts"), unescapeHTML(JSON.stringify(markers)));
}, "/Users/florentbertiaux/Documents/GitHub/xteinkhub2026/src/pages/location.astro", void 0);

const $$file = "/Users/florentbertiaux/Documents/GitHub/xteinkhub2026/src/pages/location.astro";
const $$url = "/location";
