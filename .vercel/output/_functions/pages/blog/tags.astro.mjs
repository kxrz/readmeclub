...
Explore, and discover new trends.
...
Here you will find all the tags used in our blog.
` })} <ul role="list" class="flex flex-col gap-1 mt-12"> ${tags.map((tag) => renderTemplate`${renderComponent($$result3, "Link", $$Link, { "title": tag, "variant": "link", "aria-label": tag, "href": `/blog/tags/${tag}`, "class": " flex justify-between  text-base-600 capitalize hover:text-accent-500" }, { "default": async ($$result4) => renderTemplate`${tag}<span class="flex-1 mx-2 border-dotted border-b border-base-300"></span> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-narrow-right"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M5 12l14 0"></path> <path d="M15 16l4 -4"></path> <path d="M15 8l4 4"></path> </svg> ` })}`)} </ul> ` })} </section> ` })}`;
}, "/Users/florentbertiaux/Documents/GitHub/xteinkhub2026/src/pages/blog/tags/index.astro", void 0);

const $$file = "/Users/florentbertiaux/Documents/GitHub/xteinkhub2026/src/pages/blog/tags/index.astro";
const $$url = "/blog/tags";
