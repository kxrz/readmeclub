...
import 'piccolore';
import { $ as $$BaseLayout, u as useTranslations, a as $$Wrapper, b as $$Text } from '../../chunks/BaseLayout_CmF6HVGJ.mjs';
...
const $$Board = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Seo", $$Seo, { "title": `${t("board.title")} - ${t("site.name")}`, "description": t("board.subtitle"), "canonical": `${siteUrl}/${lang}/board`, "lang": lang })} ${maybeRenderHead()}<section> ${renderComponent($$result2, "Wrapper", $$Wrapper, { "variant": "hero" }, { "default": async ($$result3) => renderTemplate` ${renderComponent($$result3, "Text", $$Text, { "tag": "h1", "variant": "displaySM", "class": "text-base-900 font-medium 2xl:text-5xl tracking-tight" }, { "default": async ($$result4) => renderTemplate`${t("board.title")}` })} ${renderComponent($$result3, "Text", $$Text, { "tag": "p", "variant": "textBase", "class": "mt-4 text-base-600 text-balance 2xl:text-xl" }, { "default": async ($$result4) => renderTemplate`${t("board.subtitle")}` })} <div class="mt-4"> <a href="#submit-feature-form" class="inline-flex items-center gap-1.5 text-sm text-base-500 hover:text-accent-500 transition-colors"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="shrink-0"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M12 5v14"></path> <path d="M5 12h14"></path> </svg> ${t("board.submit")} </a> </div> ` })} </section>  <section> ${renderComponent($$result2, "Wrapper", $$Wrapper, { "variant": "standard", "class": "py-6" }, { "default": async ($$result3) => renderTemplate` <div class="flex flex-wrap gap-2"> <a${addAttribute(`/${lang}/board`, "href")}${addAttribute(`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${statusFilter === "all" ? "bg-base-900 text-white" : "bg-base-50 text-base-700 hover:bg-base-100 ring-1 ring-base-200"}`, "class")}> ${t("board.filter.all")} </a> <a${addAttribute(`/${lang}/board?status=pending`, "href")}${addAttribute(`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${statusFilter === "pending" ? "bg-base-900 text-white" : "bg-base-50 text-base-700 hover:bg-base-100 ring-1 ring-base-200"}`, "class")}> ${t("board.filter.pending")} </a> <a${addAttribute(`/${lang}/board?status=planned`, "href")}${addAttribute(`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${statusFilter === "planned" ? "bg-base-900 text-white" : "bg-base-50 text-base-700 hover:bg-base-100 ring-1 ring-base-200"}`, "class")}> ${t("board.filter.planned")} </a> <a${addAttribute(`/${lang}/board?status=completed`, "href")}${addAttribute(`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${statusFilter === "completed" ? "bg-base-900 text-white" : "bg-base-50 text-base-700 hover:bg-base-100 ring-1 ring-base-200"}`, "class")}> ${t("board.filter.completed")} </a> <a${addAttribute(`/${lang}/board?status=rejected`, "href")}${addAttribute(`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${statusFilter === "rejected" ? "bg-base-900 text-white" : "bg-base-50 text-base-700 hover:bg-base-100 ring-1 ring-base-200"}`, "class")}> ${t("board.filter.rejected")} </a> </div> ` })} </section>  <section> ${renderComponent($$result2, "Wrapper", $$Wrapper, { "variant": "standard", "class": "py-6 pb-24" }, { "default": async ($$result3) => renderTemplate`${features && features.length > 0 ? renderTemplate`<div class="space-y-4"> ${features.map((feature) => renderTemplate`${renderComponent($$result3, "FeatureRequestCard", $$FeatureRequestCard, { "feature": feature })}`)} </div>` : renderTemplate`<div class="text-center py-12"> ${renderComponent($$result3, "Text", $$Text, { "tag": "p", "variant": "textBase", "class": "text-base-500" }, { "default": async ($$result4) => renderTemplate`${t("board.no_results")}` })} </div>`}` })} </section>  <section> ${renderComponent($$result2, "Wrapper", $$Wrapper, { "variant": "standard", "class": "py-6 pb-24" }, { "default": async ($$result3) => renderTemplate` <div class="max-w-2xl mx-auto"> ${renderComponent($$result3, "Text", $$Text, { "tag": "h2", "variant": "textXL", "class": "font-semibold text-base-900 mb-6" }, { "default": async ($$result4) => renderTemplate`${t("board.submit")}` })} <form id="submit-feature-form" class="space-y-6 bg-white ring-1 ring-base-200 rounded-lg p-6 scroll-mt-24" x-data="{ 
            submitting: false,
            success: false,
            error: null
          }" @submit.prevent="
