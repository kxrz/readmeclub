...
const $$Resources = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, {}, { "default": async ($$result2) => renderTemplate`  ${maybeRenderHead()}<section> ${renderComponent($$result2, "Wrapper", $$Wrapper, { "variant": "hero" }, { "default": async ($$result3) => renderTemplate` ${renderComponent($$result3, "Text", $$Text, { "tag": "h1", "variant": "displaySM", "class": "text-base-900 font-medium 2xl:text-5xl tracking-tight" }, { "default": async ($$result4) => renderTemplate`${t("resources.title")}` })} ${renderComponent($$result3, "Text", $$Text, { "tag": "p", "variant": "textBase", "class": "mt-4 text-base-600 text-balance 2xl:text-xl" }, { "default": async ($$result4) => renderTemplate`${t("resources.subtitle")}` })} <div class="mt-4"> <a${addAttribute(`/${lang}/submit`, "href")} class="inline-flex items-center gap-1.5 text-sm text-base-500 hover:text-accent-500 transition-colors"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="shrink-0"> <path stroke="none" d="M0 0h24v24H0z" fill="none"></path> <path d="M12 5v14"></path> <path d="M5 12h14"></path> </svg> ${t("resources.add_new")} </a> </div> ` })} </section> <section> ${renderComponent($$result2, "Wrapper", $$Wrapper, { "variant": "standard", "class": "py-6" }, { "default": async ($$result3) => renderTemplate` <div class="scrollable-content relative flex snap-x snap-proximity gap-2 py-2 px-2 overflow-x-scroll scrollbar-hide"> ${renderComponent($$result3, "Link", $$Link, { "size": "xs", "variant": "ghost", "title": t("common.filter") + ": All", "aria-label": t("common.filter") + ": All", "href": `/${lang}/resources`, "class": !type ? "bg-base-900 text-white hover:bg-base-800 ring-base-900 font-semibold" : "text-base-900 bg-white ring-2 ring-base-400 hover:ring-accent-400 hover:bg-accent-50 font-medium" }, { "default": async ($$result4) => renderTemplate`${t("common.filter")}: All
` })} ${resourceTypes.map((rt) => renderTemplate`${renderComponent($$result3, "Link", $$Link, { "size": "xs", "variant": "ghost", "title": rt.label, "aria-label": rt.label, "href": `/${lang}/resources?type=${rt.value}`, "class": type === rt.value ? "bg-base-900 text-white hover:bg-base-800 ring-base-900 font-semibold" : "text-base-900 bg-white ring-2 ring-base-400 hover:ring-accent-400 hover:bg-accent-50 font-medium" }, { "default": async ($$result4) => renderTemplate`${rt.label}` })}`)} </div>  ${resources && resources.length > 0 ? renderTemplate`<div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3 mt-2"> ${resources.map((resource) => renderTemplate`${renderComponent($$result3, "ResourceCard", $$ResourceCard, { "resource": resource })}`)} </div>` : renderTemplate`<div class="text-center py-12"> ${renderComponent($$result3, "Text", $$Text, { "tag": "p", "variant": "textBase", "class": "text-base-500" }, { "default": async ($$result4) => renderTemplate`${t("resources.no_results")}` })} </div>`}` })} </section> `, "head": async ($$result2) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, { "slot": "head" }, { "default": async ($$result3) => renderTemplate` ${renderComponent($$result3, "Seo", $$Seo, { "title": `${t("resources.title")} - ${t("site.name")}`, "description": t("resources.subtitle"), "canonical": `${siteUrl}/${lang}/resources`, "lang": lang })} ` })}` })}`;
}, "/Users/florentbertiaux/Documents/GitHub/xteinkhub2026/src/pages/[lang]/resources.astro", void 0);

const $$file = "/Users/florentbertiaux/Documents/GitHub/xteinkhub2026/src/pages/[lang]/resources.astro";
const $$url = "/[lang]/resources";
